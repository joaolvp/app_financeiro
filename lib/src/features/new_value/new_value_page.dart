...
import 'package:app_financeiro/src/features/new_value/new_value_controller.dart';
...
class NewValuePage extends StatefulWidget {
  const NewValuePage({super.key});

  @override
  State<NewValuePage> createState() => _NewValuePageState();
}
...
class _NewValuePageState extends State<NewValuePage> {
  ...
  NewValueController controller = Get.find();
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              PrimaryButton(
                  text: 'Salvar', margin: EdgeInsets.zero, function: () {
